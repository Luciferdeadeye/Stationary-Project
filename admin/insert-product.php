...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "INSERT INTO `products` (`id`, `category`, `subCategory`, `productName`, `productCompany`, `productPrice`, `productPriceBeforeDiscount`, `productDescription`, `productImage1`, `productImage2`, `productImage3`, `shippingCharge`, `productAvailability`, `postingDate`, `updationDate`) VALUES (NULL, '$category', '$subcat', '$productname', '$productcompany', '$productprice', '$productpricebd', '$productdescription', '$productimage1', '$productimage2', '$productimage3', '$productscharge', '$productavailability', current_timestamp(), NULL);");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" name="insertproduct" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="productCompany" placeholder="Enter your product company name"  required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Product Price</label>
                                                    <input type="text" class="form-control" name="productpricebd" placeholder="product price before discount" required>
                                                </div>
                                                <div class="form-group mt-3">
                                                    <label for="exampleInputPassword1">Product Price</label>
                                                    <input type="text" class="form-control" name="productprice" placeholder="product price after discount" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleTextarea1">Description</label>
                                                    <textarea class="form-control" rows="6" name="productDescription" placeholder="Enter The description of your Product..."></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Product Shipping Charge</label>
                                                    <input type="text" class="form-control" name="productShippingcharge" placeholder="delivery charges" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="productimage1" id="productimage1" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Product Image 2</label>
                                                    <input type="file" class="form-control" name="productimage2" id="productimage2" required>

                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Product Image 3</label>
                                                    <input type="file" class="form-control" name="productimage3" id="productimage3" required>
