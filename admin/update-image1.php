                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Update Product Image 1</h4>
                                        ...
                                        <form class="forms-sample" name="insertproduct" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <img src="productimages/<?php echo htmlentities($pid); ?>/<?php echo htmlentities($row['productImage1']); ?>"  height="180">
                                            </div>
                                            <div class="form-group">
                                                <label for="productimage1">New Product Image 1</label>
